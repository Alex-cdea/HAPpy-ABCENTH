...
def main():
    ...
    run_args.add_argument('--ABCENTH_options', default = "", help = 'additional options to pass to ABCENTH (run "ABCENTH -h" to see options)')
    ...
    if "ABCENTH" in args.annotator:
        ...
        subprocess.call(shlex.split('ABCENTH --genome ' + args.target_genome + ' --table ' +
            ...
            '/abcenth_cluster_info.tsv ' + str(args.ABCENTH_options)), stdout = open(args.output_dir + '/ABCENTH.gtf','w'))
